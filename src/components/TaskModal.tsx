    ...
    <Modal
      title={
        <span className="text-base font-extrabold">
          {task ? '✏️ Chỉnh sửa task' : '✨ Thêm task mới'}
        </span>
      }
      open={open}
      onOk={handleOk}
      ...
      cancelText="Hủy bỏ"
      width={600}
      okButtonProps={{ style: { background: '#6366f1', borderColor: '#6366f1', borderRadius: 8, fontWeight: 700 } }}
    ...
    >
      <Form form={form} layout="vertical" className="mt-4">
        ...
        <Form.Item name="description" label="Mô tả">
          <Input.TextArea rows={3} placeholder="Mô tả chi tiết công việc cần làm..." style={{ resize: 'vertical' }} />
        </Form.Item>
